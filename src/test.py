...
parser.add_argument('--save_name', type=str, default='sv_interpark2')
parser.add_argument('--test_path', type=str, default='/data3/sap/frcnn_keras/data/val.txt')
...
for idx, img_data in enumerate(test_imgs):
    ...
    from mv_train_two import draw_gt_pred
    import os
    file_name = os.path.basename(filepath)
    save_path = os.path.join(save_dir, file_name)
    ratio = float(C.im_size)/360
    draw_gt_pred(img, all_dets, img_data['bboxes'], ratio, save_path)
    for key in t.keys():
        if key not in T:
            T[key] = []
            P[key] = []
